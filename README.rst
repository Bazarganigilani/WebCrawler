...
The application identifies keywords for each article based on its frequency in the article's text body. By default, the most 5 frequent words in the text body of article is a keyword. A keyword is a noun and not a stopping or common word.
